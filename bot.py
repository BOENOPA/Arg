...
print(f"[SYSTEM] GUILD_ID: {GUILD_ID}")
print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
# ============================================================
# INTENTS
# ============================================================
...
class MiBot(commands.Bot):
    ...
    # DATA SYSTEM
    # ========================================================
    def get_cog_data_file(self, cog_name: str) -> Path:
    ...
    def create_cog_data_file(
        ...
        file_path = self.get_cog_data_file(cog_name)
        if file_path.exists():
            return
    ...
    async def setup_hook(self):
        ...
        if not COGS_DIR.exists():
            print("[COGS] ⚠️ La carpeta cogs no existe.")
            return
        cog_files = sorted(
            COGS_DIR.glob("*.py")
        )
...
async def main():
    if not TOKEN:
        print(
            "[FATAL] ❌ No existe "
            "DISCORD_TOKEN en las variables de entorno."
        )
        return
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
...
def start_bot():
    try:
        ...
        print(
            "[SYSTEM] Bot detenido manualmente."
        )
    except Exception as e:
        print(
            "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
